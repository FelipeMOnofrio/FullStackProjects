...
class NeighbourhoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create neighbourhood" do
    assert_difference('Neighbourhood.count') do
      post neighbourhoods_url, params: { neighbourhood: { neighbourhood: @neighbourhood.neighbourhood } }
    end
  ...
  test "should update neighbourhood" do
    patch neighbourhood_url(@neighbourhood), params: { neighbourhood: { neighbourhood: @neighbourhood.neighbourhood } }
